      ...
      <div className="full-screen">        
        ...
        <div className="user-image"> </div>
          ...
          <br></br>
            ...
            <input type="file" id="img" name="img" accept="image/*" className="choose-file"/>  
            <button type="submit" className="details-button">Change Image</button>
            </form>
            </div>
          ...
          <div className="input-group-settings">
            <label>Bio</label>
            <input type="text" /*onChange={e => setBio(e.target.value)}*/ required  />
          </div>
          <button type="submit" className="details-button">Save Changes</button>
        </form>  
        </div>
        </div>  
        </div>
