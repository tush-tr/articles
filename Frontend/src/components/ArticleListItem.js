      ...
      <div className="card-body">
        ...
        {location.pathname === "/saved-articles" ? (
          <Link to={`/article-edit/${article._id}`}>
            <i className="edit-btn fa fa-edit"></i>
          </Link>
        ) : (
          ""
        )}
        ...
        <div className="card-content">
          ...
          <span className="date">
            - <Moment format="MMM DD, YYYY">{article.publishDate}</Moment>
          </span>
          <h5 className="card-title" onClick={openArticle}>
            {article.title}
          </h5>
          <div onClick={() => openProfile(article.author._id)}>
            <img
