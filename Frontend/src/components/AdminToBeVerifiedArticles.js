      ...
      <div class="content">
        <div class="container-fluid">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">To be verified</h1>
          </div>
          <table class="table">
                    ...
                    publishedArticles && publishedArticles.map((article) => {
                        return (
                            <tr key={article._id} onClick={() => openArticle(article._id)}>
                              ...
                              <td>
                                <button on class="btn btn-primary btn-sm rounded-0" type="button" title="Delete"><i class="fa fa-check-square"></i></button>
